...
@printfomat.3 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
...
entry:
  ...
  %printtmp5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @printfomat.3, i32 0, i32 0))
  ret void
}
