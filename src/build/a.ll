...
@printfomat.7 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
...
then:                                             ; preds = %afterloop21
  ...
  %printtmp = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @printfomat, i32 0, i32 0), [256 x i8]* %0)
  br label %ifcont
...
loop113:                                          ; preds = %afterloop147, %afterloop112
  %loopentry114 = phi i32 [ 0, %afterloop112 ], [ 0, %afterloop147 ]
  store i32 0, i32* %j, align 4
  br label %loop115

loop115:                                          ; preds = %ifcont139, %loop113
  %loopentry116 = phi i32 [ 0, %loop113 ], [ 0, %ifcont139 ]
...
else130:                                          ; preds = %loop115
  ...
  %printtmp138 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @printfomat.7, i32 0, i32 0), i32 %arrayelement137)
  br label %ifcont139

ifcont139:                                        ; preds = %else130, %then121
  %iftmp140 = phi i32 [ 0, %then121 ], [ 0, %else130 ]
  %j141 = load i32, i32* %j, align 4
  %addtmp142 = add i32 %j141, 1
  store i32 %addtmp142, i32* %j, align 4
  %j143 = load i32, i32* %j, align 4
  %BN144 = load i32, i32* %BN, align 4
  %cmptmp145 = icmp slt i32 %j143, %BN144
  %loopcond146 = icmp ne i1 %cmptmp145, false
  br i1 %loopcond146, label %loop115, label %afterloop147

afterloop147:                                     ; preds = %ifcont139
  %i148 = load i32, i32* %i, align 4
  %addtmp149 = add i32 %i148, 1
  store i32 %addtmp149, i32* %i, align 4
  %i150 = load i32, i32* %i, align 4
  %AM151 = load i32, i32* %AM, align 4
  %cmptmp152 = icmp slt i32 %i150, %AM151
  %loopcond153 = icmp ne i1 %cmptmp152, false
  br i1 %loopcond153, label %loop113, label %afterloop154

afterloop154:                                     ; preds = %afterloop147
  ret void
}
